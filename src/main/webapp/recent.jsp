		...
		<table>
			...
			<tbody>
				<tr>
					...
					<td><a href="#" class="rescan-link" style="color: blue;"><i class="fa-solid fa-up-right-from-square"></i> Rescan</a> <i class="fa-solid fa-slash fa-rotate-270 fa-xs"></i> <button><i class="fas fa-trash"></i></button>
				</td>
				</tr>
				<tr>
					...
					<td style="color: rgb(1, 154, 1);">Valid</td>
					<td>31 October, 2023</td>
					<td><a href="#" class="rescan-link" style="color: blue;"><i class="fa-solid fa-up-right-from-square"></i> Rescan</a> <i class="fa-solid fa-slash fa-rotate-270 fa-xs"></i> <button><i class="fas fa-trash"></i></button></td>
				</tr>
				<tr>
					<td>gg.zip</td>
					<td>ss Rajmouli</td>
				...
				<tr>
					...
					<td>31 October, 2023</td>
					<td><a href="#" class="rescan-link" style="color: blue;"><i class="fa-solid fa-up-right-from-square"></i> Rescan</a> <i class="fa-solid fa-slash fa-rotate-270 fa-xs"></i> </i><button><i class="fas fa-trash"></i></button></td>
				</tr><tr>
					<td>bc.exe</td>
					<td>123456so</td>
					<td>98d44e13f455d916674d38424d39e1cb01b2a9132aacbb7b97a6f8bb7feb2544</td>
